...
function handleProvideAddressIntent(event, response) {
    ...
    if (address && address.value) {
        ...
        return request.get(googleApiUrl)
                .then(function (verificationResult) {
                    ...
                    if (verificationResult.status && verificationResult.status == 'OK') {
                        ...
                        speechOutput = {
                            speech: `That address seems to be invalid. Repeat your address including your city or state.`,
                            type: defaults.speechOutputType.PLAIN_TEXT
                        };

                        repromptSpeech = {
                            speech: `Please, repeat your address including your city or state.`,
                            type: defaults.speechOutputType.PLAIN_TEXT
                        };
                    }
                    ...
                    let speechOutput = {
                        speech: `I'm having some trouble verifying that address. Please, repeat it once more.`,
                        type: defaults.speechOutputType.PLAIN_TEXT
                    };

                    let repromptSpeech = {
                        speech: `Please, repeat your address.`,
                        type: defaults.speechOutputType.PLAIN_TEXT
                    };
        ...
        return new Promise(function (resolve) {
            let speechOutput = {
                speech: `I didn't quite get that. Please, repeat your address including your city or state.`,
                type: defaults.speechOutputType.PLAIN_TEXT
            };
