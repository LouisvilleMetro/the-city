...
function confirmNextAddress(event, response) {
    ...
    if (verifiedAddresses.length > 0) {
        ...
        return new Promise(function (resolve) {
            let speechOutput = {
                speech: `Let's try that again. Tell me your address as clearly as possible. Include your city or state, whichever is easier to pronounce. Ignore the zip code and unit number.`,
                type: defaults.speechOutputType.PLAIN_TEXT
            };

            let repromptSpeech = {
                speech: `Please, repeat your address clearly.`,
                type: defaults.speechOutputType.PLAIN_TEXT
            };
