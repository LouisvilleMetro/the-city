...
function handlePickupForFullAddressIntent(event, response) {
    // Check address
    let verifiedAddress = verifyAddress(event);
    ...
    if (streetAddress && zipCode && zipCode.value) {
        return usps.verifyAsync({
            ...
            if (verifiedAddress) {
                ...
                speechOutput = {
                    speech: `Uhmmm! The address you provided seems to be invalid. Please, repeat the address and make sure you include the street address and the zip code`,
                    type: AlexaSkill.speechOutputType.PLAIN_TEXT
                };
        ...
        return new Promise(function (resolve) {
            let speechOutput = {
                speech: `Uhmmm! The address you provided seems to be invalid. Uhmmm! The address you provided seems to be invalid. Please, repeat the street address, number first.`,
                type: AlexaSkill.speechOutputType.PLAIN_TEXT
            };

            let repromptSpeech = {
                speech: `Please, Uhmmm! The address you provided seems to be invalid. Please, repeat the street address, number first.`,
                type: AlexaSkill.speechOutputType.PLAIN_TEXT
            };
